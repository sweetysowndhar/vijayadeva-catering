document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    en: {
      ...
      contact_office_val: "Vizhaperundhurai, Nangudi Post, Srimushnam TK, Cuddalore District",
    ...
    ta: {
      ...
      contact_office_val: "விழப்பெருந்துறை, நாங்குடி போஸ்ட், ஸ்ரீமுஷ்ணம் தாலுகா, கடலூர் மாவட்டம்",
